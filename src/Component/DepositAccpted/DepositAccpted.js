...
import styles from './DepositAccpted.module.css';
...
const DepositAccpted = () => {
  ...
  const { DepositeAccptedList,DepositeDelete,host } = context
  ...
  const DeleteUser = async (trnsId) =>{
    await DepositeDelete(trnsId)
